...
> 关于 PR 的写法规范和 Review 流程，见 [git-workflow.md](./git-workflow.md)。
...
命名规范参考 [git-workflow.md](./git-workflow.md) 中的分支策略。
...
掌握本文内容后，阅读 [git-workflow.md](./git-workflow.md) 了解 RentHub 团队具体的分支策略、Commit 规范与 PR 流程。
