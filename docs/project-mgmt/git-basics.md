...
> 关于 PR 的写法规范和 Review 流程，见 [Git 协作工作流]({{ '/docs/project-mgmt/git-workflow.html' | relative_url }})。
...
命名规范参考 [Git 协作工作流]({{ '/docs/project-mgmt/git-workflow.html' | relative_url }}) 中的分支策略。
...
掌握本文内容后，阅读 [Git 协作工作流]({{ '/docs/project-mgmt/git-workflow.html' | relative_url }}) 了解 RentHub 团队具体的分支策略、Commit 规范与 PR 流程。
