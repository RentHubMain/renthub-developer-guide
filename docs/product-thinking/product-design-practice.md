...
理论要落地。这一章给你一套**从想法到上线的具体操作流程**，不是教科书，是 RentHub 团队可以立刻用起来的工作方式。
...
前者告诉你**为什么要做**，后者只告诉你**做什么**。只有理解了前者，你才能判断后者是不是正确的解法。
...
| 书名 | 核心价值 |
|------|---------|
| 《The Mom Test》Rob Fitzpatrick | 如何问出真实有效的用户访谈问题 |
| 《Sprint》Jake Knapp（Google Ventures） | 5天设计冲刺方法论全书 |
| 《Continuous Discovery Habits》Teresa Torres | 如何把用户研究变成日常习惯 |
| 《Shape Up》Basecamp | Basecamp 的产品开发方法论，适合小团队 |
| Paul Graham Essays | 产品思维和创业哲学最精华的一手资料 |
