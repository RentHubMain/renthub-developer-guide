...
- [Cursor 使用指南](/docs/vibe-coding/cursor-guide)：账号、模型档位、Thinking 模式与 Token 控制
- [Git 协作工作流](/docs/project-mgmt/git-workflow)：Conventional Commits 与正式提交时如何配合 `/renthub-commit`
- [新成员上手指南](/docs/quick-start/onboarding)：把本页的机制放进「从零到 PR」的实际路径里
