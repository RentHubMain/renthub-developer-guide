...
| [氛围编程 Vibe Coding](./docs/vibe-coding/) | AI 辅助开发的约定与注意点 | 进行中 |
| [项目管理](./docs/project-mgmt/) | 分支、发布、Code Review 等 | 进行中 |
...
1. **[Git 基础入门](./docs/project-mgmt/git-basics.html)** — 理解版本控制、分支、提交与 PR，是参与任何项目的前提
2. **[Cursor 使用指南](./docs/vibe-coding/cursor-guide.html)** — 了解如何用 AI 辅助开发，模型怎么选、额度怎么省
3. **[Cursor 核心概念](./docs/vibe-coding/cursor-concepts.html)** — 深入理解 Rules、Skills、MCP 等机制，让 AI 真正为你所用
4. **[Git 协作工作流](./docs/project-mgmt/git-workflow.html)** — 掌握团队协作规范，包括分支策略、Commit 写法与 PR 流程
